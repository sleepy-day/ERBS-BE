DO $$
    BEGIN
        ...
        CREATE TABLE IF NOT EXISTS user_game (
            ...
            remote_surveillance_camera INT,
            ...
            tactical_skill_ugprade_use_vf_credit INT,
        ...
        CREATE TABLE IF NOT EXISTS item_armor (
            ...
            increase_basic_attack_damage_ratio INT,
        ...
        -- weapon_route
        CREATE INDEX IF NOT EXISTS idx_weapon_route_id ON weapon_route (((weapon_route).id));
        ...
        -- item_armor
        CREATE INDEX IF NOT EXISTS idx_item_armor_code ON item_armor (code);
        CREATE INDEX IF NOT EXISTS idx_item_armor_make_material_1 ON item_armor (make_material_1);
        CREATE INDEX IF NOT EXISTS idx_item_armor_make_material_2 ON item_armor (make_material_2);
        CREATE INDEX IF NOT EXISTS gidx_item_armor_name ON item_armor USING GIN (name gin_trgm_ops);
        ...
        -- how_to_find_items
        CREATE INDEX IF NOT EXISTS idx_how_to_find_items_item_code ON how_to_find_items (item_code) INCLUDE (hunt_chicken, hunt_bat, hunt_boar, hunt_dog, hunt_wolf, hunt_bear, hunt_wickeline, hunt_alpha, hunt_omega, air_supply);

        -- item_consumable
        CREATE INDEX IF NOT EXISTS idx_item_consumable_code ON item_consumable (code);
        CREATE INDEX IF NOT EXISTS gidx_item_consumable_name ON item_consumable USING GIN (name gin_trgm_ops);

        -- item_misc
        CREATE INDEX IF NOT EXISTS idx_item_misc_code ON item_misc (code);
        CREATE INDEX IF NOT EXISTS gidx_item_misc_name ON item_misc USING GIN (name gin_trgm_ops);
        ...
        -- item_special
        CREATE INDEX IF NOT EXISTS idx_item_special_code ON item_special (code);
        CREATE INDEX IF NOT EXISTS gidx_item_special_name ON item_special USING GIN (name gin_trgm_ops);

        -- item_weapon
        CREATE INDEX IF NOT EXISTS idx_item_weapon_code ON item_weapon (code);
        CREATE INDEX IF NOT EXISTS gidx_item_weapon_name ON item_weapon USING GIN (name gin_trgm_ops);
