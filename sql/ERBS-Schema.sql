DO $$
    BEGIN
        ...
        CREATE TABLE IF NOT EXISTS skill_group (
            ...
            coefficient_english TEXT,
            expansion_tip_english TEXT
        ...
        CREATE TABLE IF NOT EXISTS character (
            ...
            lore_name_english TEXT,
            lore_height_english TEXT,
            lore_age_english TEXT,
            lore_title_english TEXT,
            lore_description_english TEXT,
            lore_gender_english TEXT
        );
        ...
        CREATE TABLE IF NOT EXISTS items (
            ...
            name_english TEXT,
            effect_english TEXT,
            item_type_english TEXT,
            weapon_type_english TEXT,
            armor_type_english TEXT,
            special_item_type_english TEXT,
            consumable_type_english TEXT,
            item_grade_english TEXT
        );
        ...
        CREATE TABLE IF NOT EXISTS tooltip_type (
            tool_tip_type TEXT,
            description_english TEXT
        );
        ...
        CREATE TABLE IF NOT EXISTS item_skill (
            ...
            item_skill_name_english TEXT,
            item_skill_body_english TEXT,
            item_skill_description_english TEXT
        );
        ...
        CREATE TABLE IF NOT EXISTS tactical_skill (
            code INT,
            name_english TEXT,
            description_english TEXT,
            coefficient_english TEXT,
